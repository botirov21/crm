...
import { mockStudent } from "../../../../mock/setting-archive/students"; 
...
const initialData = mockStudent.studentInfo.map((student) => ({
  id: student.id,
  FullName: student.student.fullName || "No data",
  PhoneNumber: student.student.phoneNumber || "No data",
  Balance: student.student.balance || "No data",
}));
...
export default function StudentsTable() {
  ...
  const columns = [
    ...
    { 
      field: "Balance", 
      headerName: <CustomToolBar>Balance</CustomToolBar>, 
      flex: 1, 
      renderCell: (params) => <CustomCellBold>{params.value}</CustomCellBold> 
    },
    {
