...
import { mockLead } from "../../../../mock/setting-archive/leads"; 
...
const initialData = mockLead.leadInfo.map((lead) => ({
  id: lead.id,
  FullName: lead.lead.fullName || "No data",
  PhoneNumber: lead.lead.phoneNumber || "No data",
  CreatedAt: lead.lead.createdAt || "No data",
  Description: lead.lead.description || "No data",
}));
...
export default function LeadsTable() {
  ...
  const columns = [
    ...
    { 
      field: "CreatedAt", 
      headerName: <CustomToolBar>Created at</CustomToolBar>, 
      flex: 1, 
      renderCell: (params) => <CustomCellBold>{params.value}</CustomCellBold> 
    },
    { 
        field: "Description", 
        headerName: <CustomToolBar>Description</CustomToolBar>, 
        flex: 1, 
        renderCell: (params) => <CustomCellBold>{params.value}</CustomCellBold> 
      },
    {
